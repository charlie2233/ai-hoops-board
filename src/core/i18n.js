...
const I18N = {
  zh: {
    ...
    share_title: '分享战术板',
    share_fallback_hint: '此设备不支持原生分享，可复制摘要、复制 JSON 或下载 JSON。',
    share_copy_summary: '复制摘要',
    share_copy_json: '复制 JSON',
    share_download_json: '下载 JSON',
    share_play_label: '战术：',
    share_play_untitled: '未命名',
    share_court_label: '球场：',
    share_ball_handler_label: '持球人：',
    share_shapes_label: '线条数量：',
    share_defenders_label: '可见防守：',
    share_shared_at_label: '导出时间：',
    share_file_fallback: '战术板',
    share_toast_summary: '已复制战术摘要',
    share_toast_json: '已复制战术 JSON',
    share_toast_download: '已下载战术 JSON',
    cancel: '取消',
    export: '导出',
  ...
  en: {
    ...
    share_fallback_hint: 'Native share is unavailable here. Copy the summary, copy the JSON, or download the JSON export.',
    share_copy_summary: 'Copy Summary',
    share_copy_json: 'Copy JSON',
    share_download_json: 'Download JSON',
    share_play_label: 'Play: ',
    share_play_untitled: 'Untitled',
    share_court_label: 'Court: ',
    share_ball_handler_label: 'Ball Handler: ',
    share_shapes_label: 'Lines: ',
    share_defenders_label: 'Visible Defenders: ',
    share_shared_at_label: 'Exported: ',
    share_file_fallback: 'board',
    share_toast_summary: 'Copied board summary',
    share_toast_json: 'Copied board JSON',
    share_toast_download: 'Downloaded board JSON',
    cancel: 'Cancel',
    export: 'Export',
  ...
  app.renderLanguageUI = function renderLanguageUI() {
    ...
    setText('save', 'save');
    setText('load', 'load');
    setText('share-board', 'share_button');
